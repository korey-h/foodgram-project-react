# Generated by Django 3.0.5 on 2021-11-05 14:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, max_length=7, null=True, validators=[recipes.validators.color_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(max_length=200, verbose_name='Название ингридиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(default=1, help_text='Если количество выбирается по вкусу, впишите здесь 1', validators=[django.core.validators.MinValueValidator(0, message='Количество не может быть отрицательным')])),
